...
import com.example.finalwork.actions.CourseAction;
import com.example.finalwork.actions.LessonAction;
import com.example.finalwork.actions.ModuleAction;
...
public class CourseController {
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // Переход на страницу курсов
    @GetMapping("/course")
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // Создание курса
    @PostMapping("/course")
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // отображение данных выбранного курса
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") //Сохранение измененных данных курса
  ...
  //      }
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // удаление курса
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // добавление модуля
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // удаление модуля
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // отображение данных модуля
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // сохранение измененных данных модуля
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // добавление урока к модулю
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // удаление урока
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // отображение данных урока
    ...
    @PreAuthorize("hasRole(T(com.example.finalwork.model.Role).ROLE_TEACHER)") // сохранение данных урока
